...
export function TechnicalEvidence({ details }: { details: AgentTaskTechnicalDetails }) {
  ...
  const rows = [
    ...
    [
      t("agent.technical.planRevision"),
      details.plan_revision_no == null ? null : String(details.plan_revision_no),
    ],
    [t("agent.technical.planningInputsHash"), details.planning_inputs_hash],
    [t("agent.technical.parentPlan"), details.parent_reviewed_plan_id],
    [t("agent.technical.parentPlanHash"), details.parent_plan_hash],
    [t("agent.technical.revisionReason"), details.revision_reason],
    [t("agent.technical.evidenceSnapshot"), details.evidence_snapshot_hash],
